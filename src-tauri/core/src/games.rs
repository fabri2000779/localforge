//! Built-in game definitions and helpers for resolving config variables.

use crate::types::{
    ConfigFile, ConfigFileFormat, FieldType, GameConfig, GameType, PortConfig, PortProtocol,
    SelectOption, SystemMapping, Variable,
};
